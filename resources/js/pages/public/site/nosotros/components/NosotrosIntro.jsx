            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-8 col-12">
                        ...
                        <p className={styles.text}>
                            Creemos que <strong>cada producto comunica.</strong> Ya sea para motivar, agradecer o conectar, transformamos tus
                            objetivos en experiencias memorables que fortalecen vínculos y generan impacto.
                        </p>
                    </div>
                </div>
            </div>
