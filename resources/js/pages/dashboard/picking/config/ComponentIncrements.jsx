        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Incrementos por Componentes</h1>
                        <p className="text-muted-foreground mt-1">Gestiona los porcentajes de incremento según cantidad de componentes por kit</p>
                    </div>
                    {!isAdding && (
                    ...
                    <CardContent>
                                        ...
                                        <TableRow key={increment.id}>
                                            ...
                                            <TableCell className="text-right">
                                                {editingId === increment.id ? (
                                                    ...
                                                    <div className="flex justify-end gap-2">
                                                        <Button size="sm" variant="outline" onClick={() => startEdit(increment)} disabled={isAdding}>
                        ...
                        <div className="bg-muted mt-4 rounded-lg p-4">
                            ...
                            <p className="text-muted-foreground text-sm">
                                El porcentaje de incremento se aplica sobre el subtotal de servicios seleccionados. Por ejemplo, un 20% significa que
                                se suma un 20% adicional al costo de los servicios.
                            </p>
                        </div>
                    </CardContent>
                </Card>
