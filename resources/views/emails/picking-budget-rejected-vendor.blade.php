{{-- resources/views/emails/picking-budget-rejected-vendor.blade.php --}}
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Presupuesto de Picking Rechazado por el Cliente</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            @endif
            <h1>Presupuesto de Picking Rechazado</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="alert-box">
                ...
                <p>El cliente ha rechazado el presupuesto de picking que le enviaste.</p>
            </div>
            ...
            <div class="next-steps">
                ...
                <ul>
                    <li>Contacta al cliente para entender mejor sus necesidades de picking</li>
                    <li>Revisa si es posible ajustar la propuesta o los costos del servicio</li>
                    <li>Considera ofrecer alternativas en los servicios o tipos de cajas</li>
            ...
            <p>Este rechazo es una oportunidad para comprender mejor las necesidades del cliente y mejorar futuras
                propuestas de servicios de picking.</p>
