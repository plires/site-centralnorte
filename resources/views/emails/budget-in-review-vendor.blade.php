{{-- resources/views/emails/budget-in-review-vendor.blade.php --}}
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Presupuesto en Evaluación por el Cliente</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            @endif
            <h1>Presupuesto en Evaluación 📋</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="next-steps">
                ...
                <ul>
                    ...
                    <li>Prepara información adicional que pueda necesitar</li>
