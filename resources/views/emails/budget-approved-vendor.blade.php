{{-- resources/views/emails/budget-approved-vendor.blade.php --}}
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Presupuesto Aprobado por el Cliente</title>
    <style>
        body {
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="success-box">
                ...
                <p>El cliente ha aprobado el presupuesto que le enviaste.</p>
            </div>
            ...
            <div class="next-steps">
                ...
                <ul>
                    <li>Contacta al cliente para coordinar los siguientes pasos</li>
                    <li>Confirma los detalles de entrega y plazos</li>
                    <li>Inicia el proceso de producción o gestión del pedido</li>
                    <li>Mantén al cliente informado sobre el progreso</li>
                </ul>
            </div>
            ...
            <p>¡Felicitaciones por cerrar esta venta! Ahora puedes proceder con la gestión del pedido.</p>
